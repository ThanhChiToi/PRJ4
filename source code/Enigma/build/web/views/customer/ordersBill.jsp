    ...
    <body>
        <div id="page" class="page">
            <div class="header">
                ...
                <div class="company" style="color: #0000FF;">Clothes Shop</div>
            </div>
            <center>
                            ...
                            <div style="float: left;width: 73%;">
                                ...
                                <div style="float: right;width: 60%; text-align: center;margin-top:15px;">
                                    ...
                                    <p style="margin:10px 0px;" align="center">
                                        Ngày<em class="em">&nbsp;(Date)</em>&nbsp;&nbsp;&nbsp;31&nbsp;&nbsp;&nbsp;tháng<em class="em">&nbsp;(month)</em>&nbsp;&nbsp;&nbsp;12&nbsp;&nbsp;&nbsp;năm<em class="em">&nbsp;(year)</em>&nbsp;&nbsp;&nbsp;2020</p>
                                </div>
                            </div>
                                ...
                                <tbody><tr>
                                        ...
                                        <td colspan="6" valign="middle">
                                            <b style="font-size:16px!important;font-weight:bold;width:800px;color:#00b9f4">
                                                &nbsp;&nbsp;Hệ Thống cửa hang Clothes Shop</b>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5" valign="middle">
                                            <span style="line-height:17px;">
                                                &nbsp;&nbsp;360 Bến Vân Đồn, P.1, Q.4, TP. Hồ Chí Minh, Việt Nam</span>
                                        </td>
                                    </tr>
                                    <tr>
