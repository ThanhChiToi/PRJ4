            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 row">
                        <div class="col-md-4">
                            <h4>Introduced</h4>
                            <a href="single.html"><img src="${context}/assets/images/abc.PNG" width="30%" alt=" " class="img-responsive" />
                            </a>
                        </div>
                        <div class="col-md-8">
                            <p>
                    ...
                    <div class="col-12 row">
                        <div class="col-md-4">
                            ...
                            <a href="single.html"><img src="${context}/assets/images/category-3.jpg" width="80%" alt=" " class="img-responsive" />
                                        </a>
                        </div>
                        <div class="col-md-8">
                            <p>
