                    ...
                    <div class="col-md-7">
                        <c:if test="${order.paymentMethod == 'momo'}">
                            ...
                            <div class="mc-loinhan text-center">
                                Recipients: <strong>Tran Thanh Thien</strong> - <strong>0785403722</strong><br>
                            ...
                            <div class="text-center mt-3">
                                <img src="${context}/assets/images/momo2.jpg" width="40%" class="img-fluid" >
                            </div>
                        </c:if>
                        <c:if test="${order.paymentMethod == 'transfer'}">
                            <h2 class="inforbank">Bank Transfer Information</h2>
                            <h3 class="name">Clothes Shop</h3>
                            <ul class="wc-bacs-bank-details order_details bacs_details">
                                <li class="bank_name">Bank: <strong>Techcombank – Branch HCM</strong></li>
                                <li class="account_number">Account number: <strong>12310000014185</strong></li>
                            </ul>
                            <h3 class="name">Tran Thanh Thien</h3>
                            <ul class="wc-bacs-bank-details order_details bacs_details">
                                <li class="bank_name">Bank: <strong>MB Bank – Branch HCM</strong></li>
