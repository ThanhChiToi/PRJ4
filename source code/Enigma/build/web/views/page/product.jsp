                            ...
                            <ul class="nav-profile">
                                <li class="item">
                                    ...
                                    <c:forEach var="item" items="${listCat}">
                                        <a href="${context}/products/sortByItem?catId=${item.categoryId}&brandId=<%= request.getParameter("brandId")%>&gender=<%=request.getParameter("gender")%>">
                                            <span>${item.name}</span>
                                        </a>
                                    </c:forEach>
                                </li>
                                <li class="item">
                                    ...
                                    <c:forEach var="item" items="${listBrand}">
                                        <a class="" href="${context}/products/sortByItem?catId=<%=request.getParameter("catId")%>&brandId=${item.brandId}&gender=<%=request.getParameter("gender")%>">
                                            <span>${item.name}</span>
                                        </a>
                                    </c:forEach>
                                </li>
                                <li class="item">
                                    ...
                                    <a class="" href="${context}/products/sortByItem?catId=<%=request.getParameter("catId")%>&brandId=<%=request.getParameter("brandId")%>&gender=1">
                                        <span>Men</span>
                                    </a>
                                    <a class="" href="${context}/products/sortByItem?catId=<%=request.getParameter("catId")%>&brandId=<%=request.getParameter("brandId")%>&gender=2">
                                        <span>Women</span>
                                    </a>
                                    <a class="" href="${context}/products/sortByItem?catId=<%=request.getParameter("catId")%>&brandId=<%=request.getParameter("brandId")%>&gender=3">
                                        <span>Unisex</span>
                                    </a>
                                </li>
                            </ul>
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            ...
                                            <div class="carousel-caption d-none d-md-block">
                                                <h1 style="font-family: 'Poppins'; letter-spacing: 0.7px; font-weight: 600;">High Fashion</h1>
                                    ...
                                    <div class="col-md-4 contentPage">
                                        <div class="block-product">
                                            ...
                                            <div href="#" class="img" data-url="${context}/assets/images/products/${url[0]}" style="background-image: url(${context}/assets/images/products/${url[0]});">
                                                <a href="${context}/products/details?id=${item.productId}" class="view"><i class="far fa-eye"></i></a>
                                            </div>
                                    ...
                                    var html = '<li class="html">'+
                                                    '<div>'+
                                                        ...
                                                        '<li id="'+dataId+'">'+
                                                            ...
                                                            '<a href="${context}/products/details?id='+dataId+'">'+
                                                                '<img src="'+url+'">'+
                                                                '<span>'+name+'</span>'+
                                                            '</a>'+
                                                            '<span class="quantity">'+
