...
<html>
    ...
    <body>
        ...
        <div class="rowbr">
        <div class="col-2">    
        <h1>High Fashion <br> Rise In Style</h1>
        <p>"It's not about how many stores you open, but the moment you hand over an item to the customer,
        Shopping is also a passion, if you want brilliantfind us"</p>
            <a href="${context}/products/" class="btn1">Learn more </a>
        </div>
        <div class="col-2">
            <img src="${context}/assets/images/image1.png">
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="block-category">
                            <div class="img"  style="background-image: url(${context}/assets/images/category-1.jpg);"></div>
                    ...
                    <div class="col-sm-4">
                        <div class="block-category">
                            <div class="img" style="background-image: url(${context}/assets/images/category-2.jpg);"> </div>
                            <div class="text-center">
                    ...
                    <div class="col-sm-4">
                        <div class="block-category">
                            <div class="img" style="background-image: url(${context}/assets/images/category-3.jpg)" ></div>
                            <div class="text-center">
                            ...
                            <div class="col-md-3    ">
                                <div class="block-product">
                                    ...
                                    <div href="#" class="img" data-url="${context}/assets/images/products/${url[0]}" style="background-image: url(${context}/assets/images/products/${url[0]});">
                                        <a href="${context}/products/details?id=${item.productId.productId}" class="view"><i class="far fa-eye"></i></a>
                                    </div>
