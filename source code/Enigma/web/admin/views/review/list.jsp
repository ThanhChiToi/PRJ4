                ...
                <div class="g-pa-20">
                    ...
                    <div class="noty noty_bar noty_type__success noty_theme__unify--v1 g-mb-25">
                        <div class="noty_body">
                            ...
                            <div>Delete review successfully</div>
                        </div>
                    </div>
                    <h1 class="g-font-weight-300 g-font-size-28 g-color-black g-mb-30">All Reviews</h1>

                    <div class="media-md align-items-center g-mb-30">
                        <div class="d-flex g-mb-15 g-mb-0--md">
                            <h3 class="g-font-weight-400 g-font-size-16 g-color-black mb-0">Table Reviews</h3>
                        </div>
                    ...
                    <div class="g-mb-40">
                        <div class="table-responsive">
                            <table class="js-datatable table u-table--v3 u-editable-table--v1 g-color-black" data-dt-info="#datatableInfo1" data-dt-search="#datatableSearch1" data-dt-entries="#datatableEntries1" data-dt-is-show-paging="true" data-dt-pagination="datatablePagination1"
                                ...
                                <th>
                                    <div class="media">
                                        <div class="d-flex align-self-center">Review</div>
                                ...
                                <th>
                                    <div class="media">
                                        <div class="d-flex align-self-center">Rating</div>
                                ...
                                <tbody>
                                    <c:forEach var="item" items="${listReview}">
                                        <tr class="item-${item.id}">
                                            ...
                                            <td><c:out value="${item.cusEmail}" /></td>
                                            <td>
                                               <c:out value="${item.productId.productName}" />
                                            </td>
                                            <td>
                                                <a href="${context}/Admin/Products/Edit?id=${item.productId.productId}">
                                                    <c:out value="${item.productId.productId}" />
                                                </a>
                                            </td>
                                            <td>
                                                ...
                                                <div class="g-pos-rel g-top-3 d-inline-block">
                                                    ...
                                                    <div id="dropDown-${item.id}" class="u-shadow-v31 g-pos-abs g-right-0 g-z-index-2 g-bg-white u-dropdown--css-animation u-dropdown--hidden u-dropdown--reverse-y" aria-labelledby="dropDown1Invoker">
                                                        <ul class="list-unstyled g-nowrap mb-0">
                                                            <li>
                                                                <a data-id="${item.id}" class="d-flex align-items-center u-link-v5 g-bg-gray-light-v8--hover g-font-size-12 g-font-size-default--md g-color-gray-dark-v6 g-px-25 g-py-14" href="${context}/Admin/Reviews/Delete?id=${item.id}&role=admin">
